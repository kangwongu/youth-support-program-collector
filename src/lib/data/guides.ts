...
const DEFAULT_PUBLISHED = '2026-03-20';
const DEFAULT_UPDATED = '2026-04-18';
const DEFAULT_AUTHOR = '청년 지원 정책 모아보기 편집팀';
...
export const guideMap = Object.fromEntries(guides.map((g) => [g.slug, g])) as Record<string, Guide>;
